 ...
 ****************************************************************************************
 */
//#define CFG_ECC_SIM_ACCEL

#define ECC_4BIT_WIN_OPT 1
...
#else
uint8_t ecc_generate_key256(const uint8_t *secret_key, const uint8_t *public_key_x, const uint8_t *public_key_y, ke_msg_id_t msg_id, ke_task_id_t task_id);
#endif

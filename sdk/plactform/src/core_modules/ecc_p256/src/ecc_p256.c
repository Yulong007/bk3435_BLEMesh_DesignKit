...
// ECC Accelerator in a simulation environment
...
__RAM_ECDH void GF_Point_Jacobian_To_Affine256(ECC_Jacobian_Point256* pJacPoint, bigHex256* pX_co_ord_affine, bigHex256* pY_co_ord_affine )
{
...
#if (ECC_4BIT_WIN_OPT==1)
__RAM_ECDH uint8_t ecc_generate_key256(u_int8 key_type, const u_int8* secret_key, const u_int8* public_key_x, const u_int8* public_key_y, ke_msg_id_t msg_id, ke_task_id_t task_id)
#else
uint8_t ecc_generate_key256(const u_int8 *secret_key, const u_int8 *public_key_x, const u_int8 *public_key_y, ke_msg_id_t msg_id, ke_task_id_t task_id)
#endif
{
...
//            ecc_elt->win_4_table = NULL;
    ...
    {
        stack_printf("====== Invalid public key value. ===== \n");
    }
#endif // CFG_ECC_SIM_ACCEL
    //  stack_printf("ecc_generate_key256 end\r\n");
    return status;
}

__RAM_ECDH void ecc_abort_key256_generation(ke_task_id_t task_id)
{
...
__RAM_ECDH void ecc_gen_new_public_key(u_int8* secret_key, ke_msg_id_t msg_id, ke_task_id_t task_id)
{
#if (ECC_4BIT_WIN_OPT == 1)

...
void init_analog_xvr_reg(void)
{
    ...
    if (system_mode == RW_DUT_MODE)
    {
        ...
        mHWreg_Assign_XVR_Regsiter(04, 0x7F935733); //0x7F915733 // 0x5F915727
        XVR_ANALOG_REG_BAK[0x04] = 0x7F935733;//0x7F915733;
    ...
    else
    {
        ...
        mHWreg_Assign_XVR_Regsiter(0B, 0xD3FD260C);// 0xD2FD260C///buck output 1.4v///0xD1FD260C//0xd1Fd240C); //0xD3DD240C  71FD240C
        XVR_ANALOG_REG_BAK[0x0B] = 0xD3FD260C; //0xD2FD260C

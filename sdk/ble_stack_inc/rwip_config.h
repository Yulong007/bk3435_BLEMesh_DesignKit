...
#elif (BLE_PERIPHERAL)
#define BLE_CONNECTION_MAX      (8)    //(7)
#else
#define BLE_CONNECTION_MAX      (0)   //(0)
...
enum KE_EVENT_TYPE
{
    ...
    KE_EVENT_H4TL_TX      = 9,
#if (BLE_EMB_PRESENT || BT_EMB_PRESENT)
    KE_EVENT_H4TL_CMD_HDR_RX  = 10,
    KE_EVENT_H4TL_CMD_PLD_RX  = 11,
#endif //(BLE_EMB_PRESENT || BT_EMB_PRESENT)
#endif //H4TL_SUPPORT

#if (BLE_HOST_PRESENT)
#if (BLE_L2CC)
    KE_EVENT_L2CAP_TX      = 12,
#endif //(BLE_L2CC)
#endif// (BLE_HOST_PRESENT)

#if BT_EMB_PRESENT
    KE_EVENT_BT_PSCAN_PROC   = 13,
#endif //BT_EMB_PRESENT

#if BLE_EMB_PRESENT
    KE_EVENT_BLE_EVT_DEFER   = 14,
    KE_EVENT_BLE_EVT_DELETE  = 15,
#endif //BLE_EMB_PRESENT

#if defined(CFG_AUDIO_AOAHI)
    KE_EVENT_BLE_AUDIO_DEFER = 16,
#endif // defined(CFG_AUDIO_AOAHI)
    KE_EVENT_AOS_CLI = 17,
    KE_EVENT_MAX        = 32,
};
...
#undef CFG_JLINK_DEBUG

/// Open JTAG DEBUG mode or not
#if defined(CFG_JLINK_DEBUG)
#define JLINK_DEBUG          1
#else /* #undef CFG_JLINK_DEBUG */
#define JLINK_DEBUG          0
#endif // defined(CFG_JLINK_DEBUG)

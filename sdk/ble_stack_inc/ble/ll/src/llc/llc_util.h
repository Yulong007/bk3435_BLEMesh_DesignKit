...
/**
 ****************************************************************************************
 * @brief Handling of starting the TX encryption and resetting the CCM counter
 *
 * @param[in] conhdl   Connection handle
 ****************************************************************************************
 */
void llc_start_enc_tx(uint16_t conhdl);
/**
 ****************************************************************************************
 * @brief Handling of starting the RX encryption and resetting the CCM counter
 *
 * @param[in] conhdl   Connection handle
 ****************************************************************************************
 */
void llc_start_enc_rx(uint16_t conhdl);

 ...
 *
 * This function set an immediate latency without starting procedure.
 *
 ...
 * @param[in]  lsto          Link supervision TO in multiple of 10ms
 ****************************************************************************************
 */
void lld_util_max_lat_compute(struct ea_elt_tag *elt, uint16_t lsto);
#endif //(BLE_PERIPHERAL || BLE_CENTRAL)

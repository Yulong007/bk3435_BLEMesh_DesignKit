...
extern void light_quick_onoff_timer(void);
    ...
    switch (param->operation)
    {
        ...
        case (GAPM_PROFILE_TASK_ADD):// 0x1B
        {
            ...
            if (!appm_add_svc())
            {
                ...
                mal_set_scanrsp_data(APP_SCNRSP_DATA, strlen(APP_SCNRSP_DATA));
                //  aos_cli_init();
                light_app_init();
        ...
        ke_task_id_t const src_id)
{
    ...
    if (app_env.conidx != GAP_INVALID_CONIDX)
    {
        ...
        ke_timer_set(APP_GATTC_EXC_MTU_CMD,TASK_APP,20);  ///add 0319

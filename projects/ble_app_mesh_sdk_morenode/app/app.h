...
#define	APP_SCANRSP_DATA_MAX_LEN   (18)
...
enum app_loc_nvds_tag
{
    ...
    NVDS_TAG_MESH_PROV_STATE,

    NVDS_TAG_POWER_RESET_CNT,

    NVDS_TAG_LIGHT_STATE,

    NVDS_TAG_FLASH_UPLOAD_PERIOD,

    NVDS_TAG_MESH_OTA_INFO,

    NVDS_TAG_MESH_OBJECT_INFO,
...
struct app_env_tag
{
    ...
    uint8_t scanrsp_data[APP_SCANRSP_DATA_MAX_LEN];

...
void bdaddr_env_init(void)
{
    ...
    co_default_bdaddr.addr[0] = 0x78;//78da07bcd71c;
    co_default_bdaddr.addr[1] = 0xda;
    co_default_bdaddr.addr[2] = 0x07;
    co_default_bdaddr.addr[3] = 0xbc;
    co_default_bdaddr.addr[4] = 0xd7;
    ...
    co_default_bdaddr.addr[0] = 0x78;//78da07bcd71d;
    co_default_bdaddr.addr[1] = 0xda;
    co_default_bdaddr.addr[2] = 0x07;
    co_default_bdaddr.addr[3] = 0xbc;
    co_default_bdaddr.addr[4] = 0xd7;
    ...
    co_default_bdaddr.addr[0] = 0x38;//38d2ca08ca20;
    co_default_bdaddr.addr[1] = 0xd2;
    co_default_bdaddr.addr[2] = 0xca;
    co_default_bdaddr.addr[3] = 0x08;
    co_default_bdaddr.addr[4] = 0xca;
    co_default_bdaddr.addr[5] = 0x20;
#elif MACf8a7632a93a3_FSD
    co_default_bdaddr.addr[0] = 0xf8;//f8a7632a93a3;
    co_default_bdaddr.addr[1] = 0xa7;
    co_default_bdaddr.addr[2] = 0x63;
    co_default_bdaddr.addr[3] = 0x2a;
    co_default_bdaddr.addr[4] = 0x93;
    co_default_bdaddr.addr[5] = 0xa3;

#elif MACf8a763444a53_FSD
    co_default_bdaddr.addr[0] = 0xf8;//f8a763444a53;
    co_default_bdaddr.addr[1] = 0xa7;
    co_default_bdaddr.addr[2] = 0x63;
    co_default_bdaddr.addr[3] = 0x44;
    co_default_bdaddr.addr[4] = 0x4A;
    co_default_bdaddr.addr[5] = 0x53;
    ...
    for (int i =0 ; i < 6; i++)
    {
        MESH_APP_PRINT_INFO("co_default_bdaddr.addr[%d] = 0x%02x\r\n", i, co_default_bdaddr.addr[i]);
    }
}
...
#endif
    MESH_APP_PRINT_ERR("--------------------2019.5.17 ------------------------------------------\r\n");
    MESH_APP_PRINT_ERR("|                                                                        |\r\n");
    MESH_APP_PRINT_ERR("----------------compiler TIME: %s -----------------\r\n", __TIME__);
    MESH_APP_PRINT_ERR("|                                                                        |\r\n");
    MESH_APP_PRINT_ERR("-------------------------------------------------------------------------\r\n");
    flash_advance_init();
    bdaddr_env_init();
...
{
    MESH_APP_PRINT_INFO("uart_rx:0x%s\n", mesh_buffer_to_hex(buf, len));
}
#endif
